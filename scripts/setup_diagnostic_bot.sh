...
echo "  Creating auto-reply: Q2-放置"
api POST /api/automations "{
  \"name\": \"診断bot: Q2-放置\",
  \"eventType\": \"message_received\",
  \"conditions\": {\"keyword\": \"放置\", \"matchType\": \"exact\"},
  \"actions\": [
...
echo "  Creating auto-reply: Q2-たまに"
api POST /api/automations "{
  \"name\": \"診断bot: Q2-たまに\",
  \"eventType\": \"message_received\",
  \"conditions\": {\"keyword\": \"たまに\", \"matchType\": \"exact\"},
  \"actions\": [
...
echo "  Creating auto-reply: Q2-毎週"
api POST /api/automations "{
  \"name\": \"診断bot: Q2-毎週\",
  \"eventType\": \"message_received\",
  \"conditions\": {\"keyword\": \"毎週\", \"matchType\": \"exact\"},
  \"actions\": [
...
echo "  Creating auto-reply: Q3-0-100"
api POST /api/automations "{
  \"name\": \"診断bot: Q3-0-100\",
  \"eventType\": \"message_received\",
  \"conditions\": {\"keyword\": \"0-100\", \"matchType\": \"exact\"},
  \"actions\": [
    {\"type\": \"reply\", \"messageType\": \"text\", \"content\": \"0-100人ですね。まずは友だちを増やすところからですね!\n\n【Q4】今いちばんの課題は?\n\n1. 友だちが増えない\n2. 反応がない\n3. リピートしない\n4. 自動化したい\n\n番号で答えてね!\"},
...
echo "  Creating auto-reply: Q3-100-500"
api POST /api/automations "{
  \"name\": \"診断bot: Q3-100-500\",
  \"eventType\": \"message_received\",
  \"conditions\": {\"keyword\": \"100-500\", \"matchType\": \"exact\"},
  \"actions\": [
    {\"type\": \"reply\", \"messageType\": \"text\", \"content\": \"100-500人、いい感じに育ってきていますね!\n\n【Q4】今いちばんの課題は?\n\n1. 友だちが増えない\n2. 反応がない\n3. リピートしない\n4. 自動化したい\n\n番号で答えてね!\"},
...
echo "  Creating auto-reply: Q3-500-1000"
api POST /api/automations "{
  \"name\": \"診断bot: Q3-500-1000\",
  \"eventType\": \"message_received\",
  \"conditions\": {\"keyword\": \"500-1000\", \"matchType\": \"exact\"},
  \"actions\": [
    {\"type\": \"reply\", \"messageType\": \"text\", \"content\": \"500-1000人、しっかり運用できていますね!\n\n【Q4】今いちばんの課題は?\n\n1. 友だちが増えない\n2. 反応がない\n3. リピートしない\n4. 自動化したい\n\n番号で答えてね!\"},
...
echo "  Creating auto-reply: Q3-1000+"
api POST /api/automations "{
  \"name\": \"診断bot: Q3-1000+\",
  \"eventType\": \"message_received\",
  \"conditions\": {\"keyword\": \"1000以上\", \"matchType\": \"exact\"},
  \"actions\": [
...
echo "  Creating auto-reply: Q4-増えない"
api POST /api/automations "{
  \"name\": \"診断bot: Q4-増えない\",
  \"eventType\": \"message_received\",
  \"conditions\": {\"keyword\": \"増えない\", \"matchType\": \"exact\"},
  \"actions\": [
    {\"type\": \"reply\", \"messageType\": \"text\", \"content\": \"友だちが増えないのが課題ですね。\n\n【Q5】LINE公式アカウントにかけられる月額予算は?\n\n1. 0円(無料プランのみ)\n2. 5,000円くらい\n3. 1万円くらい\n4. 3万円以上\n\n番号で答えてね!\"},
...
echo "  Creating auto-reply: Q4-反応ない"
api POST /api/automations "{
  \"name\": \"診断bot: Q4-反応ない\",
  \"eventType\": \"message_received\",
  \"conditions\": {\"keyword\": \"反応ない\", \"matchType\": \"exact\"},
  \"actions\": [
    {\"type\": \"reply\", \"messageType\": \"text\", \"content\": \"反応がないのが課題ですね。\n\n【Q5】LINE公式アカウントにかけられる月額予算は?\n\n1. 0円(無料プランのみ)\n2. 5,000円くらい\n3. 1万円くらい\n4. 3万円以上\n\n番号で答えてね!\"},
...
echo "  Creating auto-reply: Q4-リピートしない"
api POST /api/automations "{
  \"name\": \"診断bot: Q4-リピートしない\",
  \"eventType\": \"message_received\",
  \"conditions\": {\"keyword\": \"リピートしない\", \"matchType\": \"exact\"},
  \"actions\": [
    {\"type\": \"reply\", \"messageType\": \"text\", \"content\": \"リピートしないのが課題ですね。\n\n【Q5】LINE公式アカウントにかけられる月額予算は?\n\n1. 0円(無料プランのみ)\n2. 5,000円くらい\n3. 1万円くらい\n4. 3万円以上\n\n番号で答えてね!\"},
...
# ============================================
# 7. Q5 予算の回答キーワード自動応答 + スコア結果
# ============================================
echo ">>> Step 7: Q5 予算の回答キーワード作成(結果表示付き)"

# スコアリングロジック:
# Q1 業種: 美容室=15, 飲食店=15, 英会話=10, EC=20, その他=10
# Q2 状態: 未作成=0, 放置=5, たまに=10, 毎週=20
# Q3 友だち数: 0-100=5, 100-500=10, 500-1000=15, 1000+=20
# Q4 課題: 増えない=5, 反応ない=10, リピートしない=15, 自動化したい=20
# Q5 予算: 0円=0, 5000円=10, 1万円=15, 3万円+=20
#
# 最終スコアはタグの組み合わせで算出されるが、
# キーワード自動応答ではQ5回答時に概算レンジ別の結果を返す。
# 0円予算=低スコア帯、3万円+=高スコア帯として分岐。

echo "  Creating auto-reply: Q5-0円"
api POST /api/automations "{
  \"name\": \"診断bot: Q5-0円\",
  \"eventType\": \"message_received\",
  \"conditions\": {\"keyword\": \"0円\", \"matchType\": \"exact\"},
  \"actions\": [
    {\"type\": \"reply\", \"messageType\": \"text\", \"content\": \"診断完了! ありがとうございました!\n\n------\nあなたの診断結果\n------\n\n予算0円でもLINE公式アカウントは始められます。\n\nまだ始まったばかり。大きな伸びしろがあります!\n\n【あなたへの改善ポイント3つ】\n\n1. まずはLINE公式アカウントを開設(または再始動)しましょう。無料プランでも月200通まで配信できます。\n\n2. 友だち追加のQRコードを店頭・SNS・名刺に貼りましょう。まずは100人を目標に。\n\n3. あいさつメッセージを設定して、友だち追加直後に自動でクーポンや自己紹介を届けましょう。\n\n------\n\n無料でここまでできるのに、やらないのはもったいない!\n\nもっと詳しく知りたい方は「相談」と送ってください。\nあなたの業種に合った具体的なアドバイスをお伝えします。\"},
...
echo "    Q2: 未作成, 放置, たまに, 毎週"
echo "    Q3: 0-100, 100-500, 500-1000, 1000以上"
echo "    Q4: 増えない, 反応ない, リピートしない, 自動化したい"
echo "    Q5: 0円, 5000円, 1万円, 3万円以上"
echo "    導線: 相談"
echo ""
echo "  シナリオ: 2本"
echo "    1. 未完了リマインド (ID: $SCENARIO_REMIND_ID) - 2ステップ"
echo "    2. 完了後フォロー (ID: $SCENARIO_FOLLOW_ID) - 3ステップ"
echo ""
echo "スコアリング:"
echo "  Q1 業種: 美容室=15, 飲食店=15, 英会話=10, EC=20, その他=10"
echo "  Q2 状態: 未作成=0, 放置=5, たまに=10, 毎週=20"
echo "  Q3 友だち数: 0-100=5, 100-500=10, 500-1000=15, 1000+=20"
echo "  Q4 課題: 増えない=5, 反応ない=10, リピートしない=15, 自動化したい=20"
echo "  Q5 予算: 0円=0, 5000円=10, 1万円=15, 3万円+=20"
echo "  合計100点満点"
echo "    0-30点: まだ始まったばかり。大きな伸びしろがあります"
echo "   31-60点: 基盤はある。自動化で効率が大幅にアップできます"
echo "   61-100点: しっかり運用中。更に売上を伸ばす余地があります"
echo ""
echo "フロー: 「診断」→ Q1〜Q5回答 → スコア結果+改善ポイント → 「相談」→ コンサル導線"
echo ""
