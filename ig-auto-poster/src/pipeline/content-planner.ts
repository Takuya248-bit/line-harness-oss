  ...
  "spotsData": [
    {
      ...
      "description": "口コミから一番グッとくる体験を1文で（40文字以内）",
      "area": "正確なエリア名",
      "bestDish": "口コミで評判の料理名と一言（例: クロワッサンサンド — サクサク生地にジューシーなチキン）（40文字以内）",
      "atmosphere": "空間の雰囲気を五感で表現（例: 木のぬくもりと間接照明の隠れ家）（25文字以内）",
      "reviewQuote": "口コミから最も心に響く一文をそのまま引用（40文字以内）",
      "highlight": "一番の魅力を凝縮した一言（25文字以内）"
    }
  ],
  "summaryData": {
    "title": "まとめ",
