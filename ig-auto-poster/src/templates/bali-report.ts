...
export function buildBaliReportNode(slide: SlideData): SatoriNode {
  return h("div", {
    ...
    h("div", {
      ...
      h("span", { style: { fontSize: 40, fontWeight: 700, color: COLORS.gray, fontFamily: FONT_FAMILY } }, slide.phraseJp1 ?? slide.phraseJp ?? ""),
      ...
      h("div", {
        ...
        h("span", { style: { fontSize: 36, fontWeight: 700, color: COLORS.navy, fontFamily: FONT_FAMILY, wordBreak: "break-word", lineHeight: 1.5 } }, slide.usageTip ?? ""),
      ),
    ),
    bottomBar(),
  );
